...
<footer class="px-5" style="bottom: 0; position:sticky">
        <div class="row align-items-center justify-content-lg-between">
            ...
            <div class="col-lg-6">
                <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                    <li class="nav-item">
                        <a href="{{ route('privacy-policy') }}" class="text-reset nav-link text-xs pe-0 text-muted"
                            target="_blank">Privacy&Policy</a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('contact-us') }}" class="text-reset nav-link text-xs pe-0" target="_blank">Contact-us</a>
                    </li>
                </ul>
            </div>
            <div class="col-12 mt-2">
                <p class=" text-xs text-muted text-center">Powered By <a href="https://hyvikk.com/" class="text-reset"
                        target="_blank" style="hover">
                        Hyvikk Solutions
                    </a>
                </p>
            </div>
