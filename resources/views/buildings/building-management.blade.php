<x-app-layout>
    ...
    <main class="main-content d-flex flex-column position-relative border-radius-lg ps min-vh-100 ">
        <div class="navbar-container flex-shrink-0">
            <x-app.navbar pageName="Building Management" />
        </div>
                    ...
                    <div class="card border shadow-xs mb-4">
                        <div class="card-header border-bottom pb-0">
                            <div class="d-sm-flex align-items-center">
                                <div>
                                    <h6 class="font-weight-semibold text-lg mb-0">Building list</h6>
                                    <p class="text-sm">See information about all building</p>
                                </div>
                                <div class="ms-auto d-flex">
                                    ...
                                    <button type="button" data-bs-toggle="modal" data-bs-target="#addModal"
                                        ...
                                        <span class="btn-inner--text" style="color:#fff">Add Building</span>
                                    </button>
                                </div>
                            </div>
                        </div>
                        <div class="card-body px-0 py-0">
                            <div class="border-bottom py-3 px-3 d-sm-flex align-items-center">
                                ...
                                <div class="input-group w-sm-25 ms-auto d-flex justify-content-end">
