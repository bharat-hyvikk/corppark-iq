        ...
        @foreach ($building as $item)
            <tr id="building-{{ $item->id }}">
                ...
                <td class="text-sm cursor-pointer media-icon ps-4" data-bs-toggle="tooltip"
                    ...
                    <span class="badge badge-sm border border-success text-success loading-spinner"
                        style="display: none;">
                ...
                <td class="text-center align-middle">
                    <a href="javascript:;" class="text-secondary font-weight-bold text-xs edit-item"
                        data-id="{{ $item->id }}" data-bs-toggle="tooltip" data-bs-title="Edit Building"
                        data-bs-modal="#editModal" id="editBuildingBtn">
                    ...
                    <a href="javascript:;" data-id="{{ $item->id }}"
                        ...
                        data-bs-title="Delete Building" data-bs-toggle="modal" data-name="{{ $item->building_name }}">
