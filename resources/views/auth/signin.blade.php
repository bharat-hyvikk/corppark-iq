                        ...
                        <div class="col-xl-4 col-md-6 d-flex flex-column mx-auto">
                            <div class="card card-plain mt-8">
                                <div class="card-header pb-0 text-left bg-transparent text-center">
                                    <img src="{{ asset('assets/img/max-logo(2).svg') }}" alt=""
                                ...
                                <div class="text-center">
                                    <h6 class="text-dark text-sm">Copyright © {{ date('Y') }} {{ config("app.name") }}</h6>
                        ...
                        <div class="col-md-6">
                            <div class="position-absolute w-40 top-0 end-0 h-100 d-md-block d-none">
                                <div class="oblique-image position-absolute fixed-top ms-auto h-100 z-index-0 bg-cover ms-n8"
                                    style="background-image:url('../assets/img/login-logo.png')">
                                    <div
                                        class="blur mt-12 p-4 text-center border border-white border-radius-md position-absolute fixed-bottom m-4">
                                        <h2 class="mt-3 text-dark font-weight-bold">We strongly believe and follow in
                                            "Service first, then Sales".</h2>
                                    </div>
                                </div>
                            </div>
                        </div>
